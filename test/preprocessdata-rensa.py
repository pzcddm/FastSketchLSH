...
def main() -> None:
    ...
    # Report OpenMP runtime threads from extension if available - Commented out for Rensa-only testing
    # try:
    ...
    # RminHashLSH - Build MinHashes and LSH index
    ...
    # Band-parallel LSH (new) - Commented out for Rensa-only testing
    ...
    # # Note: LSH class does not support num_threads parameter in constructor
    ...
    # FastSketch LSH timing output - Commented out for Rensa-only testing
